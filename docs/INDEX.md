# @connectingmatrix/agent-swarm package index

## Ownership

Multi-agent swarm orchestration; binds core AI agents, advanced agents, and designer agents.
...
{
  "dependencies": {
    "@connectingmatrix/agent-swarm": "file:../packages/agent-swarm"
  }
}
```
