...
export function createConnectingmatrixAgentSwarmStubLauncher(context: RequestContext = {}): PackageLauncherPanel {
  return {
    ...
    actions: [
      { name: 'run10', label: 'run10', method: 'LOCAL' as const, description: 'Run run10 demo action' },
      { name: 'run100', label: 'run100', method: 'LOCAL' as const, description: 'Run run100 demo action' },
      { name: 'onProgress', label: 'onProgress', method: 'LOCAL' as const, description: 'Run onProgress demo action' }
    ],
...
export const Launcher = { open: createConnectingmatrixAgentSwarmStubLauncher, mode: 'stub' as const };
